...
SELECT model_id, year, brand_id, name FROM models WHERE brand_id LIKE 'pon';
...
FROM models
  JOIN brands
    USING (brand_id)
    WHERE models.name LIKE 'Mustang';
...
SELECT COUNT (model_id) FROM models WHERE brand_id LIKE 'for';
